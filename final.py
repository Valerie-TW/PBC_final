...
class page2(tk.Frame):
    ...
    def create_widget(self):
        ...
        self.labelTop1 = tk.Label(self, text="體育",bg='#8B795E',fg='white',font='微軟正黑體 12',width='7')
        ...
        self.labelTop2 = tk.Label(self, text="大學國文",bg='#8B795E',fg='white',font='微軟正黑體 12',width='7')
        ...
        self.labelTop3 = tk.Label(self, text="通識",bg='#8B795E',fg='white',font='微軟正黑體 12',width='7')
        ...
        self.labelTop4 = tk.Label(self, text="軍訓",bg='#8B795E',fg='white',font='微軟正黑體 12',width='7')
        ...
        self.labelTop5 = tk.Label(self, text="英語授課",bg='#8B795E',fg='white',font='微軟正黑體 12',width='7')
        ...
        self.labelTop6 = tk.Label(self, text="選修",bg='#8B795E',fg='white',font='微軟正黑體 12',width='7')
        ...
        self.Changebtn = tk.Button(self, text="選取完畢", command=self.change)
        self.Changebtn.grid(column=0, row=17)
